...
try {
    ...
    // Obtener comentarios directamente asociados al libro
    $query = "
    ...
    die("Error al cargar el libro: " . $e->getMessage());
}
?>
...
<head>
    ...
    <style>
        ...
        .modal-content .form-group .tag.selected {
            ...
            <div class="resource-content">
                <div class="resource-document">
                    <div class="resource-section">
                        <h2 class="resource-section__title">Libro</h2>
                        <div class="resource-document__container">
                            ...
                            <div class="resource-document__no-file">
                                ...
                                <p>No hay libro disponible para este recurso.</p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="resource-section">
                        ...
                        <div class="resource-tags">
                            <?php if (!empty($documento['etiquetas'])): ?>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                            <p>No hay etiquetas asociadas a este libro.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
