...
try {
  ...
  $query = "SELECT nombre_usuario, correo, ultima_conexion FROM usuarios WHERE id = :id";
              ...
              <div class="profile-main">
                <form class="profile-form">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($usuario['correo']); ?>">
                  </div>
                  <div class="form-group">
